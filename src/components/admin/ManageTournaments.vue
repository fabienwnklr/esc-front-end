...
export default {
  ...
  computed: {
    formTitle() {
      return this.editedIndex === -1 ? "Ajoute un tournoi" : "Modifie le tournoi";
    },
  },
  ...
  methods: {
    ...
    save() {
      ...
      if (this.editedIndex > -1) {
        ...
        this.$http
          .put(
            `/tournaments/${this.editedItem.id}`,
            this.editedItem
          )
          .then((res) => {
            ...
            Object.assign(_this.tournaments[index], res.data.values);
          })
